---
title: "Designing a Reliable AI Agent Platform: A Reference Architecture"
description: "A reference architecture for reliable agent workflows using TypeScript, Python, Redis, PostgreSQL, Docker and Kubernetes."
...
coverImageAlt: "Reference architecture for a reliable AI agent platform"
...
<Callout title="Scope and evidence">

This is a design reference. It is not a production case study. The code is illustrative and has not been presented here as a deployed or measured implementation.
...
A separate publisher would read unprocessed outbox events and publish them to Redis.
...
The outbox pattern reduces the risk that a committed workflow disappears between the database and the queue. A production implementation still needs duplicate-delivery handling, publisher coordination, and failure tests.
...
The model proposes an action. The application should authorize, validate, execute, and record it.
